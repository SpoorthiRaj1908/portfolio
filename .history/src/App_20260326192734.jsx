        ...
        <div className="projects-grid">
          ...
          <div className="project-card fade-up">
            ...
            <div className="project-content">
              ...
              <div className="project-links">
                <a href="https://wanderlust12-one.vercel.app/listings" target="_blank" rel="noopener noreferrer">
                  Live Demo
                </a>
                <a href="https://github.com/SpoorthiRaj19/wanderlust" target="_blank" rel="noopener noreferrer">
                  GitHub
                </a>
              </div>
            </div>
          ...
          <div className="project-card fade-up">
            ...
            <div className="project-content">
              ...
              <div className="project-links">
                <a href="https://convo-ai-owbu.vercel.app" target="_blank" rel="noopener noreferrer">
                  Live Demo
                </a>
                <a href="https://github.com/SpoorthiRaj1908/ConvoAI" target="_blank" rel="noopener noreferrer">
                  GitHub
                </a>
              </div>
            </div>
