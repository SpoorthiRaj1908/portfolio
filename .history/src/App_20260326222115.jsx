      ...
      <section className="hero reveal">
        <div className="hero-left">
          ...
          <div className="buttons">
            ...
            <a href="/SPOORTHI_RESUME.pdf" target="_blank" rel="noopener noreferrer" className="secondary">
              Resume
            </a>
          </div>
        </div>
        ...
        <div className="about-container">
          ...
          <div className="about-content">
            ...
            <div className="about-stats">
              <div><h3>500+</h3><span>DSA</span></div>
              <div><h3>2+</h3><span>Projects</span></div>
              <div><h3>MERN</h3><span>Stack</span></div>
            </div>
        ...
        <div className="projects-grid">
          <div className="project-card">
            ...
            <div className="project-content">
              <h3>Wanderlust</h3>
              <p>Full-stack Airbnb-style platform...</p>
              <div className="project-links">
                <a href="https://wanderlust12-one.vercel.app/listings" target="_blank">Live Demo</a>
          ...
          <div className="project-card">
            ...
            <div className="project-content">
              <h3>ConvoAI</h3>
              <p>AI-powered chat platform...</p>
              <div className="project-links">
                <a href="https://convo-ai-owbu.vercel.app" target="_blank">Live Demo</a>
                <a href="https://github.com/SpoorthiRaj1908/ConvoAI" target="_blank">GitHub</a>
              </div>
            </div>
          </div>
        </div>
